...
const itemVariants = {
  ...
  show: {
    opacity: 1,
    y: 0, // Changed this to 0 to bring it back to the original position
    transition: {
      duration: 0.5,
    },
  },
  ...
  return (
    <section className="container mx-auto mb-8 mt-12 " id="review">
      ...
      >
        ...
        >
          ...
          <div className="tracking-tighter">
            <h6>{REVIEW.name}</h6> {/* Changed to REVIEW.name */}
      ...
      <motion.div
        initial="hidden"
        whileInView="show"
        variants={containerVariants} // Should apply the containerVariants to stagger children
        viewport={{ once: true }}
      ...
      >
        {[customer1, customer2, customer3, customer4].map((customer, index) => (
          <motion.img
            ...
            src={customer}
            alt="customer"
            variants={itemVariants} // Ensure this is animated with itemVariants
