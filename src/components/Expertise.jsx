...
const itemVariants = {
  ...
  show: {
    ...
    y: 0,
    transition: {
      duration: 0.8, // Corrected the spelling of 'duration'
    },
  },
};
  ...
  return (
    <section id="expertise">
      ...
      <motion.div
        initial="hidden"
        whileInView="show"
        variants={containerVariants} // Corrected the 'variants' prop
        className="container mx-auto px-4" // Fixed the class name 'conatiner' to 'container'
      >
